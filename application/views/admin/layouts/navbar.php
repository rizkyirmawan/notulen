  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text"><?php echo $this->session->userdata('nama'); ?></span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url('admin/cg_data/'.$this->session->userdata('id')) ?>"><i class="icon-edit"></i> Update Data Diri</a></li>
        <li class="divider"></li>
        <li><a href="<?php echo base_url('admin/cg_password/'.$this->session->userdata('id')) ?>"><i class="icon-key"></i> Update Password</a></li>
      </ul>
    </li>
