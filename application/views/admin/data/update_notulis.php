...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('admin/list_notulis') ?>"> List Data Notulis</a> <a href="#" class="current">Edit Data Notulis</a> </div>
    <h1>Edit Data Notulis</h1>
  </div>
      ...
      <a href="<?php echo base_url('admin/list_notulis') ?>" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('admin/update_notulis/'.$show->id), array('class' => 'form-horizontal')) ?>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    <select name="role" class="span3">
                      <option value="General" <?php if(($show->role)=='General'){ echo 'selected'; } ?>>Notulis General</option>
                      <option value="Akademik" <?php if(($show->role)=='Akademik'){ echo 'selected'; } ?>>Notulis Akademik</option>
                      <option value="BEM" <?php if(($show->role)=='BEM'){ echo 'selected'; } ?>>Notulis BEM</option>
                    </select>
                </div>
              </div>
