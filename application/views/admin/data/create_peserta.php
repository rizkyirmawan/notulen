...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('admin/list_peserta') ?>"> List Data Peserta</a> <a href="#" class="current">Tambah Data Peserta</a> </div>
      ...
      <a href="<?php echo base_url('admin/list_peserta') ?>" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('admin/create_peserta'), array('class' => 'form-horizontal')) ?>
