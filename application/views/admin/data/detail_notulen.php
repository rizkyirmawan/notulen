...
<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dasbor</a> <a href="<?php echo base_url('admin/list_notulen') ?>"> List Data Notulen</a> <a href="#" class="current">Detail Notulen</a> </div>
    <h1>Detail Notulen</h1>
  </div>
  <div class="container-fluid">
    <hr>
    <a href="<?php echo base_url('admin/list_notulen') ?>" class="btn btn-success">Kembali</a>
    <div class="row-fluid">
      <div class="span6">
      ...
      <div class="span6">
        ...
        <a href="<?php echo base_url('report/notulen_admin/'.$show->kode) ?>" class="btn btn-danger btn-large" title="Download PDF"><i class="icon-file"></i></a>
        <div class="pull-right">
          <a href="<?php echo base_url('admin/send_notulen/'.$show->kode) ?>" class="btn btn-warning btn-large" title="Kirim Notulen"><i class="icon-envelope"></i></a>
        </div>
      </div>
  </div>
</div>
