<div id="content">
  <div id="content-header">
    ...
    <i class="icon-home"></i> Dashboard</a> <a href="<?php echo base_url('admin/list_acara') ?>"> List Data Acara</a> <a href="#" class="current">Kirim Undangan Acara</a> </div>
      ...
      <a href="#" onclick="history.go(-1)" class="btn btn-success">Kembali</a>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open(base_url('admin/send_invite/'.$show->id), array('class' => 'form-horizontal')) ?>
